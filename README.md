...
Note: `citationjs-idea` (Citation.js Idea #1) and `citationjs-nearley` are skipped
...
Idea #2, currently active in Citation.js has new tokens, a simpler `Grammar` class
